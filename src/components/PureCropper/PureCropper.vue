...
/**
 * @description 初始化 vue-cropper 图片裁剪
 */
const initCropper = () => {
...
/**
 * @description 获取裁切后的图片 (包装为Promise)
 */
	...
	<el-dialog v-model="state.isShowDialog" width="769px" :before-close="onCancel">
		...
		<template #footer>
			<span class="dialog-footer">
				...
				>
					<el-button>
						<pure-icon name="pi-carbon:image" />
						选择图片
					</el-button>
				</el-upload>
