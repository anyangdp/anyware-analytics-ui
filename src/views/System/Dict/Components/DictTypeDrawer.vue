...
import type { DictTypePageRes } from '@/api/system/interfaces/dict.interface'
...
const drawerProps = ref<DrawerProps<DictTypePageRes>>({
	isView: false,
	title: '',
	row: {}
})
 ...
 */
const acceptParams = (params: DrawerProps<DictTypePageRes>) => {
			...
			<el-row :gutter="35">
				<el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
					<el-form-item label="字典名称" prop="name" :rules="[{ required: true, message: '字典名称不能为空', trigger: 'blur' }]">
						<el-input v-model="drawerProps.row!.name" placeholder="字典名称" clearable />
					</el-form-item>
				</el-col>
				<el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
					<el-form-item label="字典编码" prop="code" :rules="[{ required: true, message: '字典编码不能为空', trigger: 'blur' }]">
						<el-input v-model="drawerProps.row!.code" placeholder="字典编码" clearable />
					</el-form-item>
				</el-col>
