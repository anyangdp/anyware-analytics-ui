...
const drawerProps = ref<DrawerProps<PosPageRes>>({
	isView: false,
	title: '',
	row: {}
})
...
// 接收父组件传过来的参数
const acceptParams = (params: DrawerProps<PosPageRes>) => {
...
const handleSubmit = () => {
	ruleFormRef.value!.validate(async valid => {
		...
		try {
			...
			ElMessage.success({ message: `${drawerProps.value.title}职位成功！` })
			...
			<el-row :gutter="35">
				<el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
					<el-form-item label="职位名称" prop="name">
						<el-input v-model="drawerProps.row!.name" placeholder="请填写职位名称" clearable></el-input>
					</el-form-item>
				</el-col>
				<el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
					<el-form-item label="职位编号" prop="code">
						<el-input v-model="drawerProps.row!.code" placeholder="请填写职位编号" clearable></el-input>
					</el-form-item>
				</el-col>
				<el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12">
					<el-form-item label="排序" prop="orderNo">
						<el-input-number v-model="drawerProps.row!.orderNo" placeholder="排序" />
					</el-form-item>
				</el-col>
				<el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12">
