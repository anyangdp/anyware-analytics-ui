...
import type { GenSeedDataReq } from '@/api/system/interfaces/database.interface'
...
const drawerProps = ref<DrawerProps<GenSeedDataReq>>({
	isView: false,
	title: '',
	row: {},
 ...
 */
const acceptParams = (params: DrawerProps<GenSeedDataReq>) => {
			...
			<el-row :gutter="35">
				...
				<el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
					<el-form-item label="后缀" prop="suffix">
						<el-input v-model="drawerProps.row!.suffix" placeholder="后缀" clearable />
					</el-form-item>
				</el-col>
				<el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
