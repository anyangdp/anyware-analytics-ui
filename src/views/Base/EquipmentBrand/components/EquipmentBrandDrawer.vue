...
const drawerProps = ref<DrawerProps<EquipmentBrandPageRes>>({
	isView: false,
	title: '',
	row: {}
})
 ...
 */
const acceptParams = (params: DrawerProps<EquipmentBrandPageRes>) => {
		...
		>
			<el-row :gutter="35">
				<el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
					<el-form-item label="品牌名称" prop="name" :rules="[{ required: true, message: '品牌名称不能为空', trigger: 'blur' }]">
						<el-input v-model="drawerProps.row.name" placeholder="请输入品牌名称" maxlength="50" show-word-limit clearable />
					</el-form-item>
				</el-col>
