...
import type { OperationUnitPageRes } from '@/api/base/interfaces/operationUnit.interface'
...
const drawerProps = ref<DrawerProps<OperationUnitPageRes>>({
	isView: false,
	title: '',
	row: {}
})
 ...
 */
const acceptParams = (params: DrawerProps<OperationUnitPageRes>) => {
		...
		>
			<el-row :gutter="35">
				<el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
					<el-form-item label="运维单位简称" prop="name" :rules="[{ required: true, message: '运维单位简称不能为空', trigger: 'blur' }]">
						<el-input v-model="drawerProps.row!.shortName" placeholder="请输入运维单位简称" maxlength="50" show-word-limit clearable />
					</el-form-item>
				</el-col>
				<el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
					<el-form-item label="运维单位名称" prop="name" :rules="[{ required: true, message: '运维单位名称不能为空', trigger: 'blur' }]">
						<el-input v-model="drawerProps.row!.name" placeholder="请输入运维单位名称" maxlength="50" show-word-limit clearable />
					</el-form-item>
				</el-col>
