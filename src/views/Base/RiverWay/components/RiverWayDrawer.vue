...
const drawerProps = ref<DrawerProps<RiverWayPageRes>>({
	isView: false,
	title: '',
	row: {}
})
 ...
 */
const acceptParams = (params: DrawerProps<RiverWayPageRes>) => {
		...
		>
			<el-row :gutter="35">
				<el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
					<el-form-item label="河道名称" prop="name" :rules="[{ required: true, message: '名称不能为空', trigger: 'blur' }]">
						<el-input v-model="drawerProps.row!.name" placeholder="请输入河道名称" maxlength="50" show-word-limit clearable />
					</el-form-item>
				</el-col>
